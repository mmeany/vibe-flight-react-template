...
class MailServiceTest extends TestCase
{
    ...
    public function testSendVerificationCodeReturnsFalseWhenSmtpUnavailable(): void
    {
        $_ENV['SMTP_HOST'] = '127.0.0.1';
        $_ENV['SMTP_PORT'] = '19999';
        $_ENV['SMTP_SECURE'] = 'none';
        ...
        $this->assertFalse($service->sendVerificationCode('user@example.com', 'user', '123456'));
    }

    public function testSendAdminNewUserNotificationReturnsFalseWhenSmtpUnavailable(): void
    {
        $_ENV['SMTP_HOST'] = '127.0.0.1';
        $_ENV['SMTP_PORT'] = '19999';
        $_ENV['SMTP_SECURE'] = 'none';
        ...
        $this->assertFalse($service->sendAdminNewUserNotification(
            ['admin@example.com'],
            'newuser',
            'new@example.com',
        ));
